...
namespace AServiceClient.Gmail
{
    public class GmailSender : SmtpSender
    {
        public GmailSender() : base("smtp.gmail.com", 587)
        {
            ...
            From = Framework.Inst.MailFrom.Login;//mgrzegorzak
            To = Framework.Inst.MailSignal.Login;//"bossasyg
            string s = Framework.Inst.MailFrom.Pass;
            client.Credentials = new NetworkCredential(From, Framework.Inst.MailFrom.Pass); //pass to mailbox
        }
